...
- Source:
  - Build only from a real, visible active region; when no active region is present, selection add MUST NOT occur (add-universal falls back to current file flow).
- Item fields:
